...
def clearTableauB(historiquexB):
    if historiquexB != "historiqueTourB":
        historiqueTourB.clear()
    if historiquexB != "historiqueCavalierB":
        historiqueCavalierB.clear()
    if historiquexB != "historiqueFouB":
        historiqueFouB.clear()
    if historiquexB != "historiqueRoiB":
        historiqueRoiB.clear()
    if historiquexB != "historiqueReineB":
...
def clearTableauN(historiquexN):
    if historiquexN != "historiqueTourN":
        historiqueTourN.clear()
    if historiquexN != "historiqueCavalierN":
        historiqueCavalierN.clear()
    if historiquexN != "historiqueFouN":
        historiqueFouN.clear()
    if historiquexN != "historiqueRoiN":
        historiqueRoiN.clear()
    if historiquexN != "historiqueReineN":
